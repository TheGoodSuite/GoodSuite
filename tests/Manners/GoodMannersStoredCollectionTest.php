...
abstract class GoodMannersStoredCollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function _setUpBeforeClass()
    {
        ...
        $service = new \Good\Service\Service([
            ...
            "inputDir" => dirname(__FILE__) . '/../testInputFiles/GoodManners/GoodMannersStoredCollectionTest',
    ...
    public function testDelayedResolvePrimitiveCollection()
    {
        ...
        foreach ($results as $result)
        {
            ...
            $this->assertFalse($result->isMyIntsExplicitlyResolved());

            $result->myInts->resolve();

            $this->assertTrue($result->myInts->isResolved());
            $this->assertTrue($result->isMyIntsExplicitlyResolved());
