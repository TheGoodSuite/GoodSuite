...
class SQLStream
{
    ...
    {
        $this->connection = mysql_connect(self::$dbhost, self::$dbuser, self::$dbpass);
        mysql_select_db(self::$dbname, $this->connection);
    }
    
    static public function setDatabaseDetails($host, $user, $pass, $name, $table)
    {
        self::$dbhost = $host;
        self::$dbuser = $user;
        self::$dbpass = $pass;
...
SQLStream::setDatabaseDetails("mysql8.000webhost.com", "a5400048_me", "passw3", "a5400048_LG", "SQLStream");
